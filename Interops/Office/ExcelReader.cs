...
namespace Atlas.Interops.Office
{
    public class ExcelReader : IDocReader, IDisposable
    {
        ...
        public DocAttributes PullAttributes(string pathToFile)
        {
            ...
            string departament = ((Microsoft.Office.Interop.Excel.Range)_title.Cells[27, 3]).Value2;
            string faculty = ((Microsoft.Office.Interop.Excel.Range)_title.Cells[28, 3]).Value2;
            string specialization = Formatter.GetSpecialization(
                ((Microsoft.Office.Interop.Excel.Range)_title.Cells[19, 3]).Value2);
            string profile = Formatter.GetProfile(
                ((Microsoft.Office.Interop.Excel.Range)_title.Cells[20, 3]).Value2);

            string grLevel = ((Microsoft.Office.Interop.Excel.Range)_title.Cells[30, 2]).Value2;
            string edLevel = Formatter.GetEducationLevel(grLevel);
            string edType = Formatter.GetEducationType(
                ((Microsoft.Office.Interop.Excel.Range)_title.Cells[32, 2]).Value2);
            int year = int.Parse(((Microsoft.Office.Interop.Excel.Range)_title.Cells[30, 21]).Value2);
